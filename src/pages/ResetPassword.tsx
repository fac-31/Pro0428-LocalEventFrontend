...
export default function ResetPassword() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      console.error('Error submitting changes:', error.response.data.errors);
      setInfoMessage('Failed to submit changes.');
    }
  }
  ...
  return (
    <div className="flex min-h-screen">
      <div className="m-auto w-full max-w-md px-4">
        ...
        <p className="text-red-400 text-center">{infoMessage}</p>
      </div>
    </div>
  );
}
